...
class Conversation(models.Model):
    seller = models.ForeignKey(
        EcommerceUser, on_delete=models.CASCADE, related_name="seller_conversations"
    )
    buyer = models.ForeignKey(
        EcommerceUser, on_delete=models.CASCADE, related_name="buyer_conversations"
    )
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(
        EcommerceUser, on_delete=models.CASCADE, related_name="sent_messages"
    )
    receiver = models.ForeignKey(
        EcommerceUser, on_delete=models.CASCADE, related_name="received_messages"
    )
