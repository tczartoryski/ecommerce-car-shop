...
const SelectedChatContext = React.createContext<SelectedChatContextType | undefined>(undefined);

export const SelectedChatProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
