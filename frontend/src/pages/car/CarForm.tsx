...
import { Typography, Stack, InputAdornment, OutlinedInput } from '@mui/material';
...
const CarForm: React.FC<CarFormProps> = ({
  make, setMake, model, setModel, year, setYear, color, setColor, description, setDescription,
  mileage, setMileage, price, setPrice, zipcode, setZipcode, city, error
}) => {
